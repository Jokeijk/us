...
# the test dataset.
def bagging_ensemble(estimators, valid_ratio, x_train, y_train, x_test, n_bootstrap=10):
...
y_test_predict = bagging_ensemble(estimators, valid_ratio, x_train, y_train, x_test)
